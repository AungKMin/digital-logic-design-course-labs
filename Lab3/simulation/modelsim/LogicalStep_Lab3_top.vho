...
-- Equation(s):
-- \inst2|Mux5~0_combout\ = (\sw[4]~input_o\ & ((\sw[7]~input_o\ & ((!\sw[5]~input_o\))) # (!\sw[7]~input_o\ & ((\sw[5]~input_o\) # (!\sw[6]~input_o\))))) # (!\sw[4]~input_o\ & (\sw[6]~input_o\ $ (((\sw[7]~input_o\) # (\sw[5]~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0001101110110110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \sw[4]~input_o\,
...
-- Equation(s):
-- \inst1|Mux5~0_combout\ = (\sw[0]~input_o\ & ((\sw[3]~input_o\ & (!\sw[1]~input_o\)) # (!\sw[3]~input_o\ & ((\sw[1]~input_o\) # (!\sw[2]~input_o\))))) # (!\sw[0]~input_o\ & (\sw[2]~input_o\ $ (((\sw[3]~input_o\) # (\sw[1]~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0110000101111110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \sw[3]~input_o\,
...
-- Equation(s):
-- \inst2|Mux1~0_combout\ = (\sw[6]~input_o\ & ((\sw[7]~input_o\ & ((\sw[5]~input_o\))) # (!\sw[7]~input_o\ & ((!\sw[5]~input_o\) # (!\sw[4]~input_o\))))) # (!\sw[6]~input_o\ & (((\sw[7]~input_o\))))
...
-- Equation(s):
-- \inst1|Mux1~0_combout\ = (\sw[2]~input_o\ & ((\sw[1]~input_o\ & ((\sw[3]~input_o\) # (!\sw[0]~input_o\))) # (!\sw[1]~input_o\ & ((!\sw[3]~input_o\))))) # (!\sw[2]~input_o\ & (((\sw[3]~input_o\))))
...
-- Equation(s):
-- \inst2|Mux0~0_combout\ = (\sw[4]~input_o\ & (!\sw[7]~input_o\ & (\sw[6]~input_o\ $ (!\sw[5]~input_o\))))
...
-- Equation(s):
-- \inst1|Mux0~0_combout\ = (\sw[0]~input_o\ & (!\sw[3]~input_o\ & (\sw[2]~input_o\ $ (!\sw[1]~input_o\))))
...
-- Equation(s):
-- \inst1|Mux6~0_combout\ = (\sw[3]~input_o\ & ((\sw[1]~input_o\ & ((\sw[2]~input_o\) # (!\sw[0]~input_o\))) # (!\sw[1]~input_o\ & ((!\sw[2]~input_o\))))) # (!\sw[3]~input_o\ & ((\sw[1]~input_o\) # ((\sw[0]~input_o\ & \sw[2]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1101110001101110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \sw[3]~input_o\,
...
-- Equation(s):
-- \inst2|Mux6~0_combout\ = (\sw[6]~input_o\ & ((\sw[5]~input_o\) # ((\sw[4]~input_o\ & !\sw[7]~input_o\)))) # (!\sw[6]~input_o\ & ((\sw[7]~input_o\ & ((!\sw[5]~input_o\) # (!\sw[4]~input_o\))) # (!\sw[7]~input_o\ & ((\sw[5]~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1101111100111000",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \sw[4]~input_o\,
...
-- Equation(s):
-- \inst2|Mux4~0_combout\ = (\sw[4]~input_o\ & (((!\sw[5]~input_o\) # (!\sw[7]~input_o\)) # (!\sw[6]~input_o\))) # (!\sw[4]~input_o\ & (\sw[6]~input_o\ $ ((\sw[7]~input_o\))))
...
-- Equation(s):
-- \inst1|Mux4~0_combout\ = (\sw[3]~input_o\ & (((!\sw[1]~input_o\ & \sw[0]~input_o\)) # (!\sw[2]~input_o\))) # (!\sw[3]~input_o\ & (((\sw[0]~input_o\) # (\sw[2]~input_o\))))
...
-- Equation(s):
-- \inst1|Mux3~0_combout\ = (\sw[3]~input_o\ & ((\sw[2]~input_o\ $ (\sw[0]~input_o\)) # (!\sw[1]~input_o\))) # (!\sw[3]~input_o\ & (\sw[1]~input_o\ $ (((\sw[2]~input_o\ & \sw[0]~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0110111101111000",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \sw[2]~input_o\,
...
-- Equation(s):
-- \inst1|Mux2~0_combout\ = (\sw[0]~input_o\ & (\sw[3]~input_o\ & ((\sw[2]~input_o\) # (\sw[1]~input_o\)))) # (!\sw[0]~input_o\ & (((\sw[1]~input_o\) # (\sw[3]~input_o\))))
...
-- Equation(s):
-- \inst2|Mux2~0_combout\ = (\sw[4]~input_o\ & (\sw[7]~input_o\ & ((\sw[6]~input_o\) # (\sw[5]~input_o\)))) # (!\sw[4]~input_o\ & (((\sw[7]~input_o\) # (\sw[5]~input_o\))))
